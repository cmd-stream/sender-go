...
require (
	github.com/cmd-stream/delegate-go v0.0.0-20260308140853-81d810b4c662 // indirect
	github.com/cmd-stream/handler-go v0.0.0-20260308162944-3e190d687853 // indirect
	github.com/cmd-stream/transport-go v0.0.0-20260308162028-cda69b948c47 // indirect
